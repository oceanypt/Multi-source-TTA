...
for lang in ${langs[@]}; do
  ...
  if [ $lang == '1' ]; then
    ...
    source_0=./outputs/newsqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    ...
    source_0=./outputs/searchqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize32_gradacc1
    ...
    source_0=./outputs/triviaqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize1_gradacc32
