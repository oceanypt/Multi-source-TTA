...
for lang in ${langs[@]}; do
  ...
  if [ $lang == '1' ]; then
    ...
    source_0=./outputs/squad/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize16_gradacc2
    source_1=./outputs/newsqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_2=./outputs/naturalqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_3=./outputs/triviaqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize1_gradacc32
    source_4=./outputs/searchqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize32_gradacc1
    ...
    source_0=./outputs/hotpotqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_1=./outputs/newsqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_2=./outputs/naturalqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_3=./outputs/triviaqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize1_gradacc32
    source_4=./outputs/searchqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize32_gradacc1
    ...
    source_0=./outputs/squad/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize16_gradacc2
    source_1=./outputs/hotpotqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_2=./outputs/newsqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_3=./outputs/naturalqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_4=./outputs/searchqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize32_gradacc1
    ...
    source_2=./outputs/naturalqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
    source_3=./outputs/triviaqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize1_gradacc32
    source_4=./outputs/newsqa/spanbert-base-cased_LR3e-5_EPOCH3.0_maxlen384_batchsize4_gradacc8
  ...
  if [ $hil == 1  ]; then
    ...
    --source_model_path $source_0 $source_1 $source_2 $source_3 $source_4 \
    ...
    --model_type ${MODEL_TYPE} \
    --model_name_or_path ${source_0} \
    --do_HIL_multi_arm_ucb_co_train_preference_f1 \
    --num_of_experts $num_of_experts \
    --threshold $threshold \
    --topk $topk \
    --neg_reward $neg_reward \
